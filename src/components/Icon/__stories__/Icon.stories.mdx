...
<Canvas>
  <Story name="Custom SVG">
    <Icon
      ...
      icon="https://cdn.mondayui.com/images/apps/custom-icons/Form.svg"
...
Icons are exported by name from `monday-ui-core/icons`:

```javascript
import { DoubleCheck } from "monday-ui-core/icons";
```
