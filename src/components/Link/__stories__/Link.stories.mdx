...
<Canvas>
  <Story name="Overview" args={{ text: "Read more", href: "https://www.mondayui.com" }}>
    {linkTemplate.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story name="States">
    <Link text="Default" href="https://www.mondayui.com" />
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Right to left">
    <Link text="اقرأ أكثر" href="https://www.mondayui.com" icon={IconLink} />
    <Link text="קרא עוד" href="https://www.mondayui.com" iconPosition={Link.iconPositions.END} icon={Info} />
  </Story>
</Canvas>
...
<Canvas>
  <Story name="With icons">
    <Link text="Read more" href="https://www.mondayui.com" icon={ExternalPage} />
    <Link text="Read more" href="https://www.mondayui.com" iconPosition={Link.iconPositions.END} icon={ExternalPage} />
  </Story>
</Canvas>
...
<ComponentRules
  rules={[
    {
      positive: {
        component: <Link text="Read more" href="https://www.mondayui.com" />,
        description: "Keep the copy short and to the point."
      },
      negative: {
        component: <Link text="Go to this url and read all about it" href="https://www.mondayui.com" />,
    ...
    },
    {
      ...
      negative: {
        component: [
          <Link text="Read this" href="https://www.mondayui.com" />,
          <span class="monday-storybook-link_text">or</span>,
          <Link text="this" href="https://www.mondayui.com" />,
          <Link text="Nice article" href="https://www.mondayui.com" />
        ],
...
<Canvas>
  <Story name="Reference link">
    <div>
      ...
      <Link inlineText inheritFontSize text="standard" href="https://www.mondayui.com" /> dummy text ever since the 1500s,
...
<Canvas>
  <Story name="Shortening texts">
    <div>
      ...
      <Link text=" Read more..." href="https://www.mondayui.com" inheritFontSize inlineText />
    </div>
  </Story>
</Canvas>
