  ...
  it("with link", () => {
    const tree = renderer
      .create(
        <Toast
          open
          actions={[{ type: Toast.actionTypes.LINK, text: "Lorem ipsum", href: "https://mondayui.com", key: 1 }]}
        >
          Something Happened
        </Toast>
      )
      ...
      .create(
        <Toast
          ...
          actions={[
            ...
            { type: Toast.actionTypes.LINK, text: "Lorem ipsum", href: "https://mondayui.com", key: 2 }
          ]}
        >
          Something Happened
        </Toast>
